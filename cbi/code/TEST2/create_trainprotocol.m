function create_trainprotocol(fpath_protocol, fpath_chanlocs)
...
protocol.train_info.setup_name = 'TRAINPROTOCOL_1';
protocol.train_info.parent_procname = 'create_trainprotocol1';
