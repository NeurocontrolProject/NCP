...
fname_expresult ='bci_expresult_LSL32_main_test.mat';
...
create_expsetup_base_LSL32_main(fpath_expsetup_base, fpath_chanlocs);
...
mkdir(dirpath_log);
log_path = fullfile(dirpath_log, 'logfile_exp_test_LSL32_main.txt');
